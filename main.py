...
img_width, img_height = 300, 300 # img dimensions
...
imgCanny = cv2.Canny(imgBlur,272,0)  # Canny edge detector to Detect edges, Parameters=>(Blurred Image, Thresh values)
